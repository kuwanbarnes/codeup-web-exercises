...
var helloMessage = sayHello("kuwan");
...
var Total = prompt('Please Type In Total:');
var Per = prompt('Please Type In Percentage:');
console.log( Total * Per);
alert("you Should Tip" + calculateTip(Per,Total));
//**
//  * TODO:
...
console.log("Sencond example:" + applyDiscount(45.99, .12))